...
const EVRangePredictor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const numericData = {
      ...
      ac_usage:
        formData.ac_usage === "off"
          ? 0
          : formData.ac_usage === "low"
          ? 1
          : formData.ac_usage === "medium"
          ? 2
          : 3,
      trip_distance: formData.trip_distance
        ? parseFloat(formData.trip_distance)
        : 0,
    };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <form
        ...
        className="space-y-6 bg-gray-800/50 p-8 rounded-xl border border-gray-700 shadow-2xl hover:shadow-blue-500 transition-shadow duration-300"
      >
          ...
          <div className="mt-6 p-6 bg-gray-700/50 rounded-lg border border-gray-600">
            ...
            <div className="space-y-2">
              ...
              {prediction.charging_suggestion && (
                <p className="text-gray-300">
                  <span className="font-medium">Charging Suggestion:</span>{" "}
                  {prediction.charging_suggestion}
                </p>
              )}
            </div>
